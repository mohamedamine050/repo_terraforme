...
resource "aws_s3_object" "glue_fifth_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_fifth.py"
  content      = <<-EOT
print("Hello from FIFTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from FIFTH script")
...
resource "aws_glue_job" "etl_fifth" {
  name              = "data-pipeline-etl-fifth-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_fifth.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                         = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                   = var.external_api_url
    "--output_path"                     = "s3://${aws_s3_bucket.output.bucket}/output-fifth/"
  }
...
resource "aws_s3_object" "glue_sixth_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_sixth.py"
  content      = <<-EOT
print("Hello from SIXTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from SIXTH script")
...
resource "aws_glue_job" "etl_sixth" {
  name              = "data-pipeline-etl-sixth-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_sixth.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                          = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                    = var.external_api_url
    "--output_path"                      = "s3://${aws_s3_bucket.output.bucket}/output-sixth/"
  }
...
resource "aws_s3_object" "glue_seventh_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_seventh.py"
  content      = <<-EOT
print("Hello from SEVENTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from SEVENTH script")
...
resource "aws_glue_job" "etl_seventh" {
  name              = "data-pipeline-etl-seventh-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_seventh.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                          = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                    = var.external_api_url
    "--output_path"                      = "s3://${aws_s3_bucket.output.bucket}/output-seventh/"
  }
...
resource "aws_s3_object" "glue_ninth_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_ninth.py"
  content      = <<-EOT
print("Hello from NINTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from NINTH script")
...
resource "aws_glue_job" "etl_ninth" {
  name              = "data-pipeline-etl-ninth-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_ninth.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                          = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                    = var.external_api_url
    "--output_path"                      = "s3://${aws_s3_bucket.output.bucket}/output-ninth/"
  }
...
resource "aws_s3_object" "glue_tenth_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_tenth.py"
  content      = <<-EOT
print("Hello from TENTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from TENTH script")
...
resource "aws_glue_job" "etl_tenth" {
  name              = "data-pipeline-etl-tenth-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_tenth.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                          = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                    = var.external_api_url
    "--output_path"                      = "s3://${aws_s3_bucket.output.bucket}/output-tenth/"
  }
...
resource "aws_s3_object" "glue_eleventh_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_eleventh.py"
  content      = <<-EOT
print("Hello from ELEVENTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from ELEVENTH script")
...
resource "aws_glue_job" "etl_eleventh" {
  name              = "data-pipeline-etl-eleventh-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_eleventh.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                          = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                    = var.external_api_url
    "--output_path"                      = "s3://${aws_s3_bucket.output.bucket}/output-eleventh/"
  }
...
resource "aws_s3_object" "glue_twelfth_script" {
  bucket       = aws_s3_bucket.scripts.id
  key          = "scripts/glue_etl_twelfth.py"
  content      = <<-EOT
print("Hello from TWELFTH script")
EOT
  content_type = "text/x-python"
  etag         = md5(<<-EOT
print("Hello from TWELFTH script")
...
resource "aws_glue_job" "etl_twelfth" {
  name              = "data-pipeline-etl-twelfth-${random_string.suffix.result}"
  role_arn          = aws_iam_role.glue_job.arn
  glue_version      = "5.0"
  number_of_workers = 2
  worker_type       = "G.1X"
  ...
  command {
    name            = "glueetl"
    script_location = "s3://${aws_s3_bucket.scripts.bucket}/scripts/glue_etl_twelfth.py"
    python_version  = "3"
  }
  ...
  default_arguments = {
    ...
    "--TempDir"                          = "s3://${aws_s3_bucket.output.bucket}/temp/"
    "--input_api_url"                    = var.external_api_url
    "--output_path"                      = "s3://${aws_s3_bucket.output.bucket}/output-twelfth/"
  }
